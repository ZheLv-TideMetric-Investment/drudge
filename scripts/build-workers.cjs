...
function compileWorkers() {
  ...
  try {
    ...
    const filesToCompile = [
      ...
      'src/workers/newsProcessorWorker.ts',
      ...
      'src/application/services/hourlySummaryService.ts',
      'src/application/services/newsLevelService.ts',
      'src/application/services/knowledgeGraphService.ts',
      'src/application/services/NewsProcessingService.ts',
      'src/domain/services/entityExtractionService.ts',
