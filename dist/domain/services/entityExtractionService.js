...
import { Event, Company, Person, Organization, Location, Time, NewsExtractionResult, } from '../entities/index.js';
import { NewsLevel, SignificanceLevel, RelationshipTypes, EventTypes } from '../../shared/types/enums.js';
/**
 * 新闻六要素提取服务
...
class EntityExtractionService {
    ...
    async extractFromNews(newsItem) {
        ...
        try {
            ...
            logger.info(`新闻 ${newsItem.id} 六要素提取完成: 事件${result.events.length}个, 公司${result.companies.length}个, ` +
