...
export const isValidSentiment = (value: any): value is Sentiment => 
  SentimentEnum.isValue(value);

export const isValidEventLevel = (value: any): value is EventLevel => 
  EventLevelEnum.isValue(value);

export const isValidOrganizationType = (value: any): value is OrganizationType => 
  OrganizationTypeEnum.isValue(value);

export const isValidLocationType = (value: any): value is LocationType => 
  LocationTypeEnum.isValue(value);

export const isValidRelationshipType = (value: any): value is RelationshipType => 
  RelationshipTypeEnum.isValue(value);

export const isValidSystemRelationshipType = (value: any): value is SystemRelationshipType => 
